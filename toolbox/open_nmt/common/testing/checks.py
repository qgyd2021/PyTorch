...
# -*- coding: utf-8 -*-
"""
Functions and exceptions for checking that models are configured correctly.
"""
...
def check_dimensions_match(dimension_1: int,
    ...
    if dimension_1 != dimension_2:
        raise ConfigurationError(f"{dim_1_name} must match {dim_2_name}, "
                                 f"but got {dimension_1} and {dimension_2} instead")
